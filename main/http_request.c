...
static int mDHT_temp=0;
static int mDHT_Humi=0;

//FFS
#define mFFS_DIR_NAME "/data/"
...
//
void set_mDHT_temp(int num){ mDHT_temp=num; }
void set_mDHT_Humi(int num){ mDHT_Humi=num; }
//
...
void http_get_task(void *pvParameters)
{
    ...
    while(1){
		...
		char sReq2[64+1];
		char sBuff[128+1];
		sprintf(sReq1, "GET %s/update?key=%s&field1=%d&field2=%d  HTTP/1.1\n" ,  WEB_URL, mAPI_KEY , mDHT_temp , mDHT_Humi );
